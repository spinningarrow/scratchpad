...
red: context [
    ...
    #import [libRedRT-file stdcall [
            ...
            f_sqrt: "f_sqrt" [] 
            f_rejoin: "f_rejoin" [] 
            f_ctx202~platform: "f_ctx202~platform" [octx [pointer! [integer!]]] 
            f_ctx227~interpreted?: "f_ctx227~interpreted?" [octx [pointer! [integer!]]] 
            f_ctx238~on-change*: "f_ctx238~on-change*" [octx [pointer! [integer!]]] 
            f_ctx236~on-change*: "f_ctx236~on-change*" [octx [pointer! [integer!]]] 
            f_ctx236~on-deep-change*: "f_ctx236~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx251~throw-error: "f_ctx251~throw-error" [octx [pointer! [integer!]]] 
            f_ctx251~make-time: "f_ctx251~make-time" [octx [pointer! [integer!]]] 
            f_ctx251~to-word: "f_ctx251~to-word" [octx [pointer! [integer!]]] 
            f_ctx251~pop: "f_ctx251~pop" [octx [pointer! [integer!]]] 
            f_ctx251~store: "f_ctx251~store" [octx [pointer! [integer!]]] 
            f_ctx251~transcode: "f_ctx251~transcode" [octx [pointer! [integer!]]] 
            f_ctx271~on-change*: "f_ctx271~on-change*" [octx [pointer! [integer!]]] 
            f_ctx274~on-change*: "f_ctx274~on-change*" [octx [pointer! [integer!]]] 
            f_ctx274~on-deep-change*: "f_ctx274~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx277~eval: "f_ctx277~eval" [octx [pointer! [integer!]]] 
            f_ctx277~eval-reaction: "f_ctx277~eval-reaction" [octx [pointer! [integer!]]] 
            f_ctx277~pending?: "f_ctx277~pending?" [octx [pointer! [integer!]]] 
            f_ctx277~check: "f_ctx277~check" [octx [pointer! [integer!]]] 
            f_clear-reactions: "f_clear-reactions" [octx [pointer! [integer!]]] 
            f_dump-reactions: "f_dump-reactions" [octx [pointer! [integer!]]] 
            f_ctx277~is~: "f_ctx277~is~" [octx [pointer! [integer!]]] 
            f_react?: "f_react?" [octx [pointer! [integer!]]] 
            f_react: "f_react" [octx [pointer! [integer!]]] 
            f_ctx288~do-quit: "f_ctx288~do-quit" [octx [pointer! [integer!]]] 
            f_ctx288~throw-error: "f_ctx288~throw-error" [octx [pointer! [integer!]]] 
            f_ctx288~syntax-error: "f_ctx288~syntax-error" [octx [pointer! [integer!]]] 
            f_ctx288~do-safe: "f_ctx288~do-safe" [octx [pointer! [integer!]]] 
            f_ctx288~do-code: "f_ctx288~do-code" [octx [pointer! [integer!]]] 
            f_ctx288~count-args: "f_ctx288~count-args" [octx [pointer! [integer!]]] 
            f_ctx288~func-arity?: "f_ctx288~func-arity?" [octx [pointer! [integer!]]] 
            f_ctx288~fetch-next: "f_ctx288~fetch-next" [octx [pointer! [integer!]]] 
            f_ctx288~eval: "f_ctx288~eval" [octx [pointer! [integer!]]] 
            f_ctx288~do-macro: "f_ctx288~do-macro" [octx [pointer! [integer!]]] 
            f_ctx288~register-macro: "f_ctx288~register-macro" [octx [pointer! [integer!]]] 
            f_ctx288~reset: "f_ctx288~reset" [octx [pointer! [integer!]]] 
            f_ctx288~expand: "f_ctx288~expand" [octx [pointer! [integer!]]] 
            ...
            f_ctx316~on-change*: "f_ctx316~on-change*" [octx [pointer! [integer!]]] 
            f_ctx316~on-deep-change*: "f_ctx316~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx320~on-change*: "f_ctx320~on-change*" [octx [pointer! [integer!]]] 
            f_ctx320~on-deep-change*: "f_ctx320~on-deep-change*" [octx [pointer! [integer!]]] 
            f_ctx324~on-change*: "f_ctx324~on-change*" [octx [pointer! [integer!]]] 
            f_ctx327~on-change*: "f_ctx327~on-change*" [octx [pointer! [integer!]]] 
            f_ctx330~offset?: "f_ctx330~offset?" [octx [pointer! [integer!]]] 
            f_ctx330~index?: "f_ctx330~index?" [octx [pointer! [integer!]]] 
            f_ctx330~line-height: "f_ctx330~line-height" [octx [pointer! [integer!]]] 
            f_ctx330~layout: "f_ctx330~layout" [octx [pointer! [integer!]]] 
            f_ctx336~capture-events: "f_ctx336~capture-events" [octx [pointer! [integer!]]] 
            f_ctx336~awake: "f_ctx336~awake" [octx [pointer! [integer!]]] 
            f_ctx344~init: "f_ctx344~init" [octx [pointer! [integer!]]] 
            f_draw: "f_draw" [] 
            f_ctx352~title-ize: "f_ctx352~title-ize" [octx [pointer! [integer!]]] 
            f_ctx352~sentence-ize: "f_ctx352~sentence-ize" [octx [pointer! [integer!]]] 
            f_ctx352~capitalize: "f_ctx352~capitalize" [octx [pointer! [integer!]]] 
            f_ctx352~adjust-buttons: "f_ctx352~adjust-buttons" [octx [pointer! [integer!]]] 
            f_ctx352~Cancel-OK: "f_ctx352~Cancel-OK" [octx [pointer! [integer!]]] 
            f_ctx350~process: "f_ctx350~process" [octx [pointer! [integer!]]] 
            f_ctx348~throw-error: "f_ctx348~throw-error" [octx [pointer! [integer!]]] 
            f_ctx348~process-reactors: "f_ctx348~process-reactors" [octx [pointer! [integer!]]] 
            f_ctx348~calc-size: "f_ctx348~calc-size" [octx [pointer! [integer!]]] 
            f_ctx348~align-faces: "f_ctx348~align-faces" [octx [pointer! [integer!]]] 
            f_ctx348~resize-child-panels: "f_ctx348~resize-child-panels" [octx [pointer! [integer!]]] 
            f_ctx348~process-draw: "f_ctx348~process-draw" [octx [pointer! [integer!]]] 
            f_ctx348~pre-load: "f_ctx348~pre-load" [octx [pointer! [integer!]]] 
            f_ctx348~add-option: "f_ctx348~add-option" [octx [pointer! [integer!]]] 
            f_ctx348~add-flag: "f_ctx348~add-flag" [octx [pointer! [integer!]]] 
            f_ctx348~fetch-value: "f_ctx348~fetch-value" [octx [pointer! [integer!]]] 
            f_ctx348~fetch-argument: "f_ctx348~fetch-argument" [octx [pointer! [integer!]]] 
            f_ctx348~fetch-expr: "f_ctx348~fetch-expr" [octx [pointer! [integer!]]] 
            f_ctx348~fetch-options: "f_ctx348~fetch-options" [octx [pointer! [integer!]]] 
            f_ctx348~make-actor: "f_ctx348~make-actor" [octx [pointer! [integer!]]] 
            ...
            set-quiet: "set-quiet" [word [red-word!] value [cell!]] 
            ...
            ctx251~make-hm: "ctx251~make-hm" [h [integer!] m [integer!]] 
            ctx251~make-msf: "ctx251~make-msf" [m [integer!] s [float!]] 
            ctx251~make-hms: "ctx251~make-hms" [h [integer!] m [integer!] s [integer!]] 
            ctx251~make-hmsf: "ctx251~make-hmsf" [h [integer!] m [integer!] s [float!]] 
            ctx251~make-binary: "ctx251~make-binary" [start [red-string!] end [red-string!] base [integer!]] 
            ctx251~make-tuple: "ctx251~make-tuple" [start [red-string!] end [red-string!]] 
            ctx251~make-number: "ctx251~make-number" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx251~make-float: "ctx251~make-float" [start [red-string!] end [red-string!] type [red-datatype!]] 
            ctx251~make-hexa: "ctx251~make-hexa" [start [red-string!] end [red-string!] return: [integer!]] 
            ctx251~make-char: "ctx251~make-char" [start [red-string!] end [red-string!]] 
            ctx251~push-path: "ctx251~push-path" [stack [red-block!] type [red-datatype!]] 
            ctx251~set-path: "ctx251~set-path" [stack [red-block!]] 
            ctx251~make-word: "ctx251~make-word" [src [red-string!] type [red-datatype!]] 
            ctx251~new-line: "ctx251~new-line" [series [cell!]] 
            ctx259~encode: "ctx259~encode" [img [red-image!] where [cell!]] 
            ctx259~decode: "ctx259~decode" [data [cell!]] 
            ctx262~encode: "ctx262~encode" [img [red-image!] where [cell!]] 
            ctx262~decode: "ctx262~decode" [data [cell!]] 
            ctx265~encode: "ctx265~encode" [img [red-image!] where [cell!]] 
            ctx265~decode: "ctx265~decode" [data [cell!]] 
            ctx268~encode: "ctx268~encode" [img [red-image!] where [cell!]] 
            ctx268~decode: "ctx268~decode" [data [cell!]] 
            event?: "event?" [value [cell!] return: [logic!]] 
            find-flag?: "find-flag?" [facet [cell!] flag [red-word!]] 
            ctx344~make-null-handle: "ctx344~make-null-handle" [] 
            ctx344~get-screen-size: "ctx344~get-screen-size" [id [integer!]] 
            ctx344~size-text: "ctx344~size-text" [face [red-object!] value [cell!]] 
            ctx344~on-change-facet: "ctx344~on-change-facet" [owner [red-object!] word [red-word!] value [cell!] action [red-word!] new [cell!] index [integer!] part [integer!]] 
            ctx344~update-font: "ctx344~update-font" [font [red-object!] flags [integer!]] 
            ctx344~update-para: "ctx344~update-para" [face [red-object!] flags [integer!]] 
            ctx344~destroy-view: "ctx344~destroy-view" [face [red-object!] empty? [logic!]] 
            ctx344~update-view: "ctx344~update-view" [face [red-object!]] 
            ctx344~refresh-window: "ctx344~refresh-window" [h [red-handle!]] 
            ctx344~redraw: "ctx344~redraw" [face [red-object!]] 
            ctx344~show-window: "ctx344~show-window" [id [red-handle!]] 
            ctx344~make-view: "ctx344~make-view" [face [red-object!] parent [red-handle!]] 
            ctx344~draw-image: "ctx344~draw-image" [image [red-image!] cmds [red-block!]] 
            ctx344~draw-face: "ctx344~draw-face" [face [red-object!] cmds [red-block!]] 
            ctx344~do-event-loop: "ctx344~do-event-loop" [no-wait? [logic!]] 
            ctx344~request-font: "ctx344~request-font" [font [red-object!] selected [red-object!] mono? [logic!]] 
            ctx344~request-file: "ctx344~request-file" [title [red-string!] name [red-file!] filter [red-block!] save? [logic!] multi? [logic!]] 
            ctx344~request-dir: "ctx344~request-dir" [title [red-string!] dir [red-file!] filter [red-block!] keep? [logic!] multi? [logic!]] 
            ctx344~text-box-layout: "ctx344~text-box-layout" [box [red-object!]] 
            ctx344~text-box-metrics: "ctx344~text-box-metrics" [state [red-block!] arg0 [cell!] type [integer!]] 
            ctx344~update-scroller: "ctx344~update-scroller" [scroller [red-object!] flags [integer!]] 
